...
# blocks
CMD="kafka-streams-application-reset --zookeeper zookeeper:2181 --bootstrap-servers kafka-1:9091 --application-id block-summaries-processor --input-topics blocks"
echo "COMMAND: $CMD"
