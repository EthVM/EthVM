        ...
        <v-container class="mx-2 mx-sm-6 mx-md-auto mx-lg-6 mx-xl-auto px-4 px-sm-6 pb-2">
            <v-row justify="space-between" class="flex-wrap">
                <v-col cols="12" lg="3" class="mb-10 mb-lg-0" order="1">
                    <a to="/">
                        <v-img src="~/assets/logo.svg" height="25" width="80" contain />
                    </a>
                    <v-img
                        v-if="lgAndUp"
                        src="~/assets/hero/hero-blocks.png"
                        width="225"
                        height="225"
                        max-width="250"
                        max-height="250"
                ...
                <v-col cols="6" sm="6" lg="2" class="mb-11 mb-lg-0" order="2">
                    ...
                    <ul class="footer-item-lists pa-0 text-capitalize">
                        <li class="mb-2">
                            <a :href="routeAbout" class="text-link">{{ $t('home.footer.about') }}</a>
                        </li>
                        <li class="mb-2">
                            <a :href="routePPolicy" class="text-link">{{ $t('home.footer.policy') }}</a>
                        </li>
                        <li class="mb-2">
                            <a href="https://help.myetherwallet.com/en/" class="text-link" target="_blank">{{ $t('home.footer.help') }}</a>
                        </li>
                        <li class="mb-2">
                            <a :href="routeAdvertise" class="text-link">{{ $t('home.footer.advertise') }}</a>
                        </li>
                    </ul>
                </v-col>
                <v-col cols="12" sm="6" lg="3" class="mb-11 mb-lg-0" order="4" order-sm="4" order-lg="3">
                    ...
                    <div class="mt-5">
                        <div class="mb-2">
                            <a :href="routeEth" target="_blank" class="d-inline-flex align-center primary--text">
                                <v-img
                ...
                >
                    ...
                    <div class="d-flex font-weight-light align-center justify-sm-end">
                        ...
                        <div class="d-flex align-center">
                            <v-img src="~/assets/logo/mew-long-white.png" width="80" min-height="24" contain />
                        </div>
                    </div>
                </v-col>
...
const routeEth = 'https://www.ethvm.com/address/0xdecaf9cd2367cdbb726e904cd6397edfcae6068d'
const routeAbout = 'https://www.ethvm.com/about'
const routeAdvertise = 'https://www.ethvm.com/advertise-with-us'
const routeSettings = 'https://www.ethvm.com/settings'
const routePPolicy = 'https://www.ethvm.com/privacy-policy'

const { lgAndUp, mdAndDown } = useDisplay()
const version = ref(runtimeConfig.ethVMVersion || '0')
const socialIcons = [
    {
    ...
    },
    {
        ...
        img: '~/assets/social-media/twitter.svg',
    ...
    },
    {
        ...
        img: '~/assets/social-media/reddit.svg',
    ...
    },
    {
        ...
        img: '~/assets/social-media/telegram.svg',
