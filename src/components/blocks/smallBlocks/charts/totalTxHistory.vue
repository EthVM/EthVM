...
const DES = {
  BEGIN: 'Total sucessfull and failed transaction in Ethereum blockchain since the ',
  OTHER: 'Total sucessfull and failed transaction in Ethereum blockchain in last '
}
