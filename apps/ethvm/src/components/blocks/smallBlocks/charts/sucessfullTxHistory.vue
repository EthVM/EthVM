...
const DES = {
  BEGIN: 'Number of Successful transactions in Ethereum blockchain since the ',
  OTHER: 'Number of Successful transactions in Ethereum blockchain in last '
}
