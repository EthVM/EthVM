<template>
  <div id="mobile-menu" class="mobile-menu">
    <div v-if="!getActive"><i class="fa fa-bars" aria-hidden="true" v-on:click="setActive()"></i></div>
    <div v-else class="show-menu">
      <div class="row1"><img src="~@/assets/logo-white.png" /> <i class="fa fa-times" aria-hidden="true" v-on:click="setActive()"></i></div>
      <div class="mobile-search-block"><block-search></block-search></div>
      <ul>
