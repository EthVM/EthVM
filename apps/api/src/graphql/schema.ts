...
export interface IQuery {
    ...
    transactionSummariesForAddress(address: string, filter?: FilterEnum, searchHash?: string, sortField?: TxSortField, order?: Order, offset?: number, limit?: number): TransactionSummaryPage | Promise<TransactionSummaryPage>;
