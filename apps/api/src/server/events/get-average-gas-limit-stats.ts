...
const getAvgGasLimitStats: SocketEvent = {
  id: Events.getAverageGasLimitStats,
  ...
  onEvent: (server: EthVMServer, socket: SocketIO.Socket, payload: any): Promise<Statistic[]> =>
    server.statisticsService.getAverageGasLimit(payload.duration)
}

export default getAvgGasLimitStats
