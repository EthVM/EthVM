...
const getTxsEvent: SocketEvent = {
  ...
  onEvent: (server: EthVMServer, socket: SocketIO.Socket, payload: any): Promise<Tx[]> => server.txsService.getTxs(payload.format, payload.limit, payload.order, payload.fromBlock)
}
