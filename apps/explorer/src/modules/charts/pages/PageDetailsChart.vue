<template>
  <v-container grid-list-lg class="mb-0">
    ...
    <chart-timeseries v-if="chartId === ChartType.difficulty"
    ...
    <chart-timeseries v-if="chartId === ChartType.gasPrice"
    ...
    <chart-timeseries v-if="chartId === ChartType.txFees"
