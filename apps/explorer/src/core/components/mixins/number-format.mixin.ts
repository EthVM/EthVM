...
*/
   ...
   * @returns  Object FormattedNumber with value as formatted string, unit and tooltipText
   */
  formatVariableUnitEthValue(value: BigNumber, ethBreakpoint: number = TenTrillion, allowRounding?: boolean): FormattedNumber {
  ...
  private convertToBillions(value: BigNumber): FormattedNumber {
