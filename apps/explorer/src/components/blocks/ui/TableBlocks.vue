...
import AppFootnotes from '@app/components/core/ui/AppFootnotes.vue'
import TableBlocksRow from '@app/components/blocks/ui/TableBlocksRow.vue'
import { Block } from '@app/models'
import { Footnote } from '@app/components/core/props'
