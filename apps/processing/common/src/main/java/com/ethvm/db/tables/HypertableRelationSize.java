...
public class HypertableRelationSize extends TableImpl<HypertableRelationSizeRecord> {
    ...
    private static final long serialVersionUID = 1037280648;
    ...
    public <O extends Record> HypertableRelationSize(Table<O> child, ForeignKey<O, HypertableRelationSizeRecord> key) {
