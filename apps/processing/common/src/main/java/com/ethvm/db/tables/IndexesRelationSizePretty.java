...
public class IndexesRelationSizePretty extends TableImpl<IndexesRelationSizePrettyRecord> {
    ...
    private static final long serialVersionUID = 1167804688;
    ...
    public <O extends Record> IndexesRelationSizePretty(Table<O> child, ForeignKey<O, IndexesRelationSizePrettyRecord> key) {
