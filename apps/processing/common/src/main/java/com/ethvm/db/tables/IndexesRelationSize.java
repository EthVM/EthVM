...
public class IndexesRelationSize extends TableImpl<IndexesRelationSizeRecord> {
    ...
    private static final long serialVersionUID = 1814297897;
    ...
    public <O extends Record> IndexesRelationSize(Table<O> child, ForeignKey<O, IndexesRelationSizeRecord> key) {
