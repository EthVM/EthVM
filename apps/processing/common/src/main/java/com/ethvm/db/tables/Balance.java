...
public class Balance extends TableImpl<BalanceRecord> {
    ...
    private static final long serialVersionUID = 2091576312;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.BALANCE_PKEY, Indexes.IDX_ALL_TOKEN_BALANCES_FOR_CONTRACT, Indexes.IDX_BALANCES_BY_BLOCK_NUMBER, Indexes.IDX_BALANCES_FOR_ADDRESS, Indexes.IDX_ETHER_BALANCE_FOR_ADDRESS, Indexes.IDX_TOKEN_BALANCES_FOR_CONTRACT);
    }
