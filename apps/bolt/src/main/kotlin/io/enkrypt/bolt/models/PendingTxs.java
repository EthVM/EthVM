...
public class PendingTxs extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<PendingTx> transactions;
   ...
   */
  public PendingTxs(java.util.List<PendingTx> transactions) {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: transactions = (java.util.List<PendingTx>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<PendingTx> getTransactions() {
    return transactions;
  }
   ...
   */
  public void setTransactions(java.util.List<PendingTx> value) {
   ...
   * @return A new PendingTxs RecordBuilder
   */
  public static Builder newBuilder(PendingTxs other) {
    return new Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PendingTxs>
    ...
    /** Array of transactions */
    private java.util.List<PendingTx> transactions;
     ...
     * @param other The existing instance to copy.
     */
    private Builder(PendingTxs other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.transactions)) {
        this.transactions = data().deepCopy(fields()[0].schema(), other.transactions);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setTransactions(java.util.List<PendingTx> value) {
    ...
    public PendingTxs build() {
      try {
        ...
        record.transactions = fieldSetFlags()[0] ? this.transactions : (java.util.List<PendingTx>) defaultValue(fields()[0]);
        return record;
      } catch (Exception e) {
