      ...
      .reduce(
        { memo, next ->
          ...
          if (next.getBigIntegerValue() != null) {
            ...
            metricBuilder.bigIntegerValue = memoBigInt.add(nextBigInt).toByteBuffer()
          }
        ...
        { aggMetric, metricsCount ->
          ...
          if (metricsCount < 2) {
            ...
            if (aggMetric.getBigIntegerValue() != null) {
              ...
              metricBuilder.bigIntegerValue = aggBigInt.divide(BigInteger.valueOf(metricsCount)).toByteBuffer()
            }
