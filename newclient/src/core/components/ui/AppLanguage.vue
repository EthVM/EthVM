<template>
    <div>
        <v-layout row align-center justify-end>
            ...
            <v-select v-model="language" :items="items" item-text="name" item-value="_id" solo flat class="lang-select" @change="changeLocale" />
        </v-layout>
    </div>
</template>
...
export default class AppLanguage extends Vue {
  ...
  */
    ...
    items = [
        { _id: 'en_US', name: 'English' },
        { _id: 'ru_RU', name: 'Russian' }
    ]
    language = 'en_US'
    loaded = ['en_US']
