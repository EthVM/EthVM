...
import FavAddrTableHeader from '@app/modules/favorite-address/components/FavAddrTableHeader.vue'
import FavAddrTableRowHandler from '@app/modules/favorite-address/handlers/FavHandlerAddressListRow.vue'
import FavBtnAdd from '@app/modules/favorite-address/components/FavBtnAdd.vue'
import FavBtnRemove from '@app/modules/favorite-address/components/FavBtnRemove.vue'
import FavSearch from '@app/modules/favorite-address/components/FavSearch.vue'
...
import { DialogAddress } from '@app/modules/favorite-address/models/FavDialog'
import { EnumAdrChips } from '@app/core/components/props'
import { FILTER_VALUES, FavSort } from '@app/modules/favorite-address/models/FavSort'
