...
const Q_ADDRESS_TRANSFERS = ['all', 'internal', 'tx-history', 'pending']
const Q_TXS_DETAILS = ['state', 'more']

export { ROUTE_NAME, ROUTE_PROP, ADDRESS_ROUTE_QUERY, Q_TOKEN_DETAILS, Q_BLOCKS_AND_TXS, Q_BLOCK_DETAILS, Q_TXS_DETAILS, Q_ADDRESS_TRANSFERS }
