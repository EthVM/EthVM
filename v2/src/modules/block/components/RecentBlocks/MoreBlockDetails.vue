    ...
    <v-card variant="flat" class="pa-4 pa-sm-6">
        ...
        <template v-else>
            ...
            <div class="block-info mb-5">
                ...
                <app-transform-hash is-blue :hash="props.blockDetails.stateRoot.detail" class="w-100" />
            </div>
            <div class="block-info mb-5">
                <p class="text-button mb-1">Receipt Root</p>
                <app-transform-hash is-blue :hash="props.blockDetails.receiptsRoot.detail" class="w-100" />
            </div>
            <div class="block-info mb-5">
                <p class="text-button mb-1">Transaction Root</p>
                <app-transform-hash is-blue :hash="props.blockDetails.transactionsRoot.detail" class="w-100" />
            </div>
            <div class="block-info mb-5">
            ...
            <div class="block-info mb-5">
                ...
                <app-transform-hash is-blue :hash="props.blockDetails.unclesSHA3.detail" class="w-100" />
            </div>
        </template>
    </v-card>
</template>
