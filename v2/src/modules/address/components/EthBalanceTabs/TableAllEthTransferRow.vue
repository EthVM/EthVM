<template>
    ...
    <app-table-row v-else row-align="center">
        <v-col sm="3" lg="2">
            <div class="d-flex">
                ...
                <div class="ml-4">
                    ...
                    <app-chip v-if="mdAndDown" :bg="transferType.color" :text="transferType.text.toUpperCase()" class="tiny-text" style="min-width: 120px" />
                </div>
            </div>
        </v-col>
        ...
        <v-col sm="2">
            <app-chip v-if="!isBlockReward" :bg="transferDirection.color" :text="transferDirection.direction" size="x-small" class="tiny-text text-uppercase" />
        </v-col>
        <v-col sm="3" lg="2">
